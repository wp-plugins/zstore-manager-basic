...
class _Zazzle_Store_Display_Basic
{
	...
	}	private function get_li_height($gridCellSize)	{		$height = $gridCellSize ;		switch($gridCellSize){		case 50: /*tiny*/			if($this->options['showProductTitle']== 'true')				$height += 10*16;									if ( $this->options['showByLine'] == 'true')				$height += 16 *4;							if(($this->options['showProductDescription']  == 'true') &&		    ($this->options['useShortDescription'] == 'true')){				$height += 16*10;							}			else {			if(($this->options['showProductDescription']  == 'true') &&		   ($this->options['useShortDescription'] == 'false'))					$height += 16*20;								}			    break;	case 92: /*small */					if($this->options['showProductTitle']== 'true')				$height += 8*16;								if ( $this->options['showByLine'] == 'true')				$height += 16*2;						if(($this->options['showProductDescription']  == 'true') &&		    ($this->options['useShortDescription'] == 'true')){				$height += 16*6;							}			else {			if(($this->options['showProductDescription']  == 'true') &&		   ($this->options['useShortDescription'] == 'false'))					$height += 16*16;								}							break;		case 152: /*medium */		if($this->options['showProductTitle']== 'true')				$height += 16*4;								if ( $this->options['showByLine'] == 'true')				$height += 16;				if(($this->options['showProductDescription']  == 'true') &&		    ($this->options['useShortDescription'] == 'true')){				$height += 16*4;							}			else {			if(($this->options['showProductDescription']  == 'true') &&		   ($this->options['useShortDescription'] == 'false'))					$height += 16*10;								}								break;		case 210:  /* large */					if($this->options['showProductTitle']== 'true')			$height += 16*3;				if ( $this->options['showByLine'] == 'true')				$height +=  16;							if(($this->options['showProductDescription']  == 'true') &&		    ($this->options['useShortDescription'] == 'true')){				$height += 16*3;							}			else {			if(($this->options['showProductDescription']  == 'true') &&		   ($this->options['useShortDescription'] == 'false'))					$height += 16*8;								}										break;		case 328: /* huge */				if($this->options['showProductTitle']== 'true')			$height += 16*2;				if ( $this->options['showByLine'] == 'true')				$height += 16;							if(($this->options['showProductDescription']  == 'true') &&		    ($this->options['useShortDescription'] == 'true')){				$height += 16*2;							}				else {				if(($this->options['showProductDescription']  == 'true') &&					($this->options['useShortDescription'] == 'false'))						$height += 16*2.25;									}				break;		}					if($this->options['showProductPrice']== 'true')			$height += 16*2;						return $height;		}
			...
			if ( $rs['items_count'] > 0) {
				...
				foreach( $rs as $key=>$val)  {
					...
					if($this->options['showProductPrice'] == 'true') 
						...
						$y .="</a>";
						$y .= "<a href=\"$link\" style=width:".$gridCellSize ."px $nofollow class=\"z_productTitle zoomClass zoomClassTitle\" title=\"$title\" $targetWindow >$title</a>" ;
